...
save(data, file = "data_1D_100k.RData")
...
data
write.csv(data,"data_1D_100k_csv.csv")
...
write.table(train_x,"train_x_100k.csv", row.names = F, col.names = F)
write.table(train_y,"train_y_100k.csv", row.names = F, col.names = F)


write.table(test_x,"test_x_100k.csv", row.names = F, col.names = F)
write.table(test_y,"test_y_100k.csv", row.names = F, col.names = F)
