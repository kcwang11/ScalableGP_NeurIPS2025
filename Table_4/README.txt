...
Step HS-SVD: Open the HS-SVD_2D_Dense.Rmd file and follow the instructions. Make sure that your working directory leads to the Table_4 folder.

Step NNGP: Open the nngp_2D_Dense.Rmd file and follow the instructions. Make sure that your working directory leads to the Table_4 folder.

Step GPyTorch: Open the Simulations_2D_Dense.ipynb file and follow the instructions. Make sure that your working directory leads to the Table_4 folder.